package mjaroslav.mcmods.realisticbrewingstand.gloomyfolken.hooklib.helper;
 ...
 * Файл methods.csv лежит в mcp/conf/ Настоятельно рекомендую сгенерировать
 * methods.bin самостоятельно для своей версии mcp, иначе могут быть внезапные
 * ошибки уровня "can not find target method of hook".
 */
