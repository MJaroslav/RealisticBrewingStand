...
public class ExampleHookLoader extends HookLoader {
    ...
    // включает саму HookLib'у. Делать это можно только в одном из
    // HookLoader'ов.
    // При желании, можно включить gloomyfolken.hooklib.minecraft.HookLibPlugin
    // и
    // не указывать здесь это вовсе.
    @Override
